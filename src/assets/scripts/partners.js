...
function loadPartners() {
    ...
    for (var i = 0; i < partners.length; i++) {
        ...
        "<div class=\"partner-content \">\n" +
            "<img src=\"" + partner.image + "\" class=\"partner-avatar\" alt=\"" + partner.name + "\"/>\n" + 
            "<span class=\"header-partner\">"+ partner.name + "</span>" +
            "<span class=\"desc-partner\">"+ partner.description + "</span>" +
        "</div>";
    }
}
